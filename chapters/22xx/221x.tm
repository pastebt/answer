...
<\body>
  ...
  <\eqnarray*>
    ...
    <frac|1|x>=<choice|<tformat|<table|<row|<cell|<frac|\<pi\>|2>,>|<cell|if
    x\<gtr\>0>|<cell|>>|<row|<cell|-<frac|\<pi\>|2>,>|<cell|if
    x\<less\>0>|<cell|>>>>>>>|<row|<cell|>|<cell|>|<cell|0\<less\>\<alpha\>\<less\>\<pi\>\<rightarrow\>sin
