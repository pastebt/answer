...
<\body>
  ...
  <\eqnarray*>
    ...
    a\<neq\>0|)>>>|<row|<cell|F<around*|(|t|)>>|<cell|=>|<cell|<big|int>t<rsup|n-1>\<times\><frac|-<frac|2*sin<rsup|2>
  ...
  <\eqnarray*>
    ...
    x>>|<row|<cell|>|<cell|>|<cell|>>|<row|<cell|f<around*|(|x|)>>|<cell|=>|<cell|<frac|sin
    ...
    a|2*sin<rsup|2> <frac|x+a|2>>>>|<row|<cell|>|<cell|>|<cell|>>|<row|<cell|>|<cell|>|<cell|d
    t=<frac|sin a|2*sin<rsup|2> <frac|x+a|2>>*d
    x>>|<row|<cell|>|<cell|>|<cell|d x=<frac|2|sin a>*sin<rsup|2>
    <frac|x+a|2>*d t>>|<row|<cell|>|<cell|>|<cell|>>|<row|<cell|f<around*|(|x|)>>|<cell|=>|<cell|<big|int><frac|sin
    ...
    x=<frac|<frac|1|2>|<frac|1|2>*<around*|(|cos x+1|)>>*d
    x>>|<row|<cell|>|<cell|>|<cell|d x=<around*|(|cos x+1|)>*d
    t=<frac|2|1+t<rsup|2>>*d t>>|<row|<cell|>|<cell|>|<cell|>>|<row|<cell|f<around*|(|x|)>>|<cell|=>|<cell|<big|int><frac|sin
    <frac|x-a|2>|sin <frac|x+a|2>>*d x>>|<row|<cell|>|<cell|=>|<cell|<big|int><frac|sin
    ...
    x=<big|int><frac|1-cos<around*|(|x-a|)>|1-cos<around*|(|x+a|)>>*d
    x>>|<row|<cell|sin<rsup|2> \<theta\>>|<cell|=>|<cell|<frac|1-cos
    2*\<theta\>|2>>>|<row|<cell|sin <frac|x-a|2>*sin
    <frac|x+a|2>>|<cell|=>|<cell|<frac|1|2>*<around*|(|cos a-cos
    x|)>>>|<row|<cell|cos<around*|(|\<alpha\>\<pm\>\<beta\>|)>>|<cell|=>|<cell|cos
    \<alpha\>*cos \<beta\>\<mp\>sin \<alpha\>*sin
    \<beta\>>>|<row|<cell|>|<cell|>|<cell|>>|<row|<cell|g<around*|(|x|)>>|<cell|=>|<cell|<big|int><frac|1-<around*|(|cos
    x*cos a+sin x*sin a|)>|2*sin<rsup|2> <frac|x+a|2>>*d
    x>>|<row|<cell|>|<cell|=>|<cell|<big|int><frac|1+<around*|(|cos x*cos
    a-sin x*sin a|)>-2*cos x*cos a|2*sin<rsup|2> <frac|x+a|2>>*d
    x>>|<row|<cell|>|<cell|=>|<cell|<big|int><frac|1+<around*|(|cos x*cos
    a-sin x*sin a|)>-2*cos x*cos a+2*cos<rsup|2> a-2*cos<rsup|2>
    a|2*sin<rsup|2> <frac|x+a|2>>*d x>>|<row|<cell|>|<cell|=>|<cell|<big|int><frac|2*cos
    a*<around*|(|cos a-cos x|)>-<around*|(|1-cos<around*|(|x+a|)>|)>+2-2*cos<rsup|2>
    a|2*sin<rsup|2> <frac|x+a|2>>*d x>>|<row|<cell|>|<cell|=>|<cell|<big|int><frac|4*cos
    a*sin <frac|x-a|2>*sin <frac|x+a|2>-2*sin<rsup|2>
    <frac|x+a|2>+2*sin<rsup|2> a|2*sin<rsup|2> <frac|x+a|2>>*d
    x>>|<row|<cell|>|<cell|=>|<cell|2*cos a*<big|int><frac|sin
    <frac|x-a|2>|sin <frac|x+a|2>>*d x-<big|int>d x+sin<rsup|2>
    a*<big|int><frac|d x|sin<rsup|2> <frac|x+a|2>>>>|<row|<cell|>|<cell|>|<cell|>>|<row|<cell|I<rsub|n>>|<cell|=>|<cell|<big|int><around*|(|<frac|sin
    <frac|x-a|2>|sin <frac|x+a|2>>|)><rsup|n>*d
    x>>|<row|<cell|>|<cell|=>|<cell|<big|int><around*|(|<frac|sin
    <frac|x-a|2>|sin <frac|x+a|2>>|)><rsup|n-2>\<times\><around*|(|<frac|sin
    <frac|x-a|2>|sin <frac|x+a|2>>|)><rsup|2>*d
    x>>|<row|<cell|>|<cell|=>|<cell|2*cos a*<big|int><around*|(|<frac|sin
    <frac|x-a|2>|sin <frac|x+a|2>>|)><rsup|n-1>*d
    x-<big|int><around*|(|<frac|sin <frac|x-a|2>|sin
    <frac|x+a|2>>|)><rsup|n-2>*d x+sin<rsup|2>
    a*<big|int><frac|<around*|(|sin <frac|x-a|2>|)><rsup|n-2>|<around*|(|sin
    <frac|x+a|2>|)><rsup|n>>*d x>>|<row|<cell|>|<cell|=>|<cell|2*cos
    a*I<rsub|n-1>-I<rsub|n-2>+sin<rsup|2>
    a*k<around*|(|x|)>>>|<row|<cell|k<around*|(|x|)>>|<cell|=>|<cell|<big|int><frac|<around*|(|sin
    <frac|x-a|2>|)><rsup|n-2>|<around*|(|sin <frac|x+a|2>|)><rsup|n>>*d
    x>>|<row|<cell|>|<cell|>|<cell|t=<frac|sin <frac|x-a|2>|sin
    <frac|x+a|2>>>>|<row|<cell|>|<cell|>|<cell|d t=<frac|sin a|2*sin<rsup|2>
    <frac|x+a|2>>*d x>>|<row|<cell|>|<cell|>|<cell|d x=<frac|2|sin
    a>*sin<rsup|2> <frac|x+a|2>*d t>>|<row|<cell|k<around*|(|t|)>>|<cell|=>|<cell|<big|int><frac|t<rsup|n-2>|sin<rsup|2>
    <frac|x+a|2>>\<times\><frac|2|sin a>*sin<rsup|2> <frac|x+a|2>*d
    t=<frac|2|sin a>*<big|int>t<rsup|n-2>*d
    t=<frac|2*t<rsup|n-1>|<around*|(|n-1|)>*sin
    a>>>|<row|<cell|I<rsub|n>>|<cell|=>|<cell|2*cos
    a*I<rsub|n-1>-I<rsub|n-2>+sin<rsup|2>
    a\<times\><frac|2*t<rsup|n-1>|<around*|(|n-1|)>*sin
    a>>>|<row|<cell|>|<cell|=>|<cell|2*cos
    a*I<rsub|n-1>-I<rsub|n-2>+<frac|2*sin
    a|n-1>*t<rsup|n-1>>>|<row|<cell|>|<cell|>|<cell|>>|<row|<cell|>|<cell|>|<cell|>>|<row|<cell|>|<cell|>|<cell|>>|<row|<cell|>|<cell|>|<cell|>>|<row|<cell|>|<cell|>|<cell|>>|<row|<cell|>|<cell|>|<cell|>>|<row|<cell|>|<cell|>|<cell|>>|<row|<cell|I<rsub|n>>|<cell|=>|<cell|<big|int><around*|(|<frac|sin
    <frac|x-a|2>|sin <frac|x+a|2>>|)><rsup|n>*d
    x>>|<row|<cell|>|<cell|=>|<cell|<big|int><frac|<around*|(|sin
    <frac|x-a|2>|)><rsup|n-2>-<around*|(|sin
    <frac|x-a|2>|)><rsup|n-2>*<around*|(|cos
    <frac|x-a|2>|)><rsup|2>|<around*|(|sin <frac|x+a|2>|)><rsup|n>>*d
    x>>|<row|<cell|>|<cell|=>|<cell|<big|int><frac|<around*|(|sin
    <frac|x-a|2>|)><rsup|n-2>|<around*|(|sin <frac|x+a|2>|)><rsup|n>>*d
    x-<frac|<around*|(|sin <frac|x-a|2>|)><rsup|n-2>*<around*|(|cos
    <frac|x-a|2>|)><rsup|2>|<around*|(|sin <frac|x+a|2>|)><rsup|n>>*d
    x>>|<row|<cell|>|<cell|=>|<cell|<big|int><frac|<around*|(|sin
    <frac|x-a|2>|)><rsup|n-2>|<around*|(|sin <frac|x+a|2>|)><rsup|n>>*d
    x-<frac|<around*|(|sin <frac|x-a|2>|)><rsup|n-2>|2*<around*|(|sin
    <frac|x+a|2>|)><rsup|n>>*d x-<frac|<around*|(|sin
    <frac|x-a|2>|)><rsup|n-2>*cos <around*|(|x-a|)>|2*<around*|(|sin
    ...
    x>>|<row|<cell|>|<cell|>|<cell|>>|<row|<cell|>|<cell|>|<cell|>>|<row|<cell|I<rsub|n>>|<cell|=>|<cell|<big|int><around*|(|<frac|sin
    <frac|x-a|2>|sin <frac|x+a|2>>|)><rsup|n>*d
    ...
    <frac|x+a|2>>\<times\><around*|(|sin <frac|x-a|2>|)><rsup|n>|)>>>|<row|<cell|>|<cell|=>|<cell|<frac|-1|2*<around*|(|cos
    <frac|x+a|2>|)><rsup|2>>\<times\><around*|(|sin
    <frac|x-a|2>|)><rsup|n>+<frac|n*cos <frac|x-a|2>|2*cos
    <frac|x+a|2>>*<around*|(|sin <frac|x-a|2>|)><rsup|n-1>>>|<row|<cell|>|<cell|>|<cell|>>|<row|<cell|<text|III.
    >sin \<alpha\>*cos \<beta\>>|<cell|=>|<cell|<frac|1|2>*<around*|[|sin<around*|(|\<alpha\>-\<beta\>|)>+sin<around*|(|\<alpha\>+\<beta\>|)>|]>>>|<row|<cell|>|<cell|>|<cell|t=<frac|sin
    <frac|x-a|2>|sin <frac|x+a|2>>=<frac|sin <frac|x-a|2>*cos
    <frac|x-a|2>|sin <frac|x+a|2>*cos <frac|x-a|2>>=<frac|sin
    <around*|(|x-a|)>|sin a+sin x>>>|<row|<cell|>|<cell|>|<cell|t=<frac|sin
    <frac|x-a|2>|sin <frac|x+a|2>>=<frac|sin <frac|x-a|2>*cos
    <frac|x+a|2>|sin <frac|x+a|2>*cos <frac|x+a|2>>=<frac|-sin a+sin
    x|sin<around*|(|x+a|)>>>>|<row|<cell|>|<cell|>|<cell|t<rsup|2>=<frac|1-cos
    <around*|(|x-a|)>|1-cos <around*|(|x+a|)>>=<frac|1-<around*|(|cos x*cos
    a+sin x*sin a|)>|1-<around*|(|cos x*cos a-sin x*sin
    a|)>>>>|<row|<cell|>|<cell|>|<cell|>>|<row|<cell|>|<cell|>|<cell|2*I<rsub|n-1>*cos
    a-I<rsub|n-2>+<frac|2*sin a|n-1>*t<rsup|n-1>>>|<row|<cell|f<around*|(|x|)>>|<cell|=>|<cell|<around*|(|<frac|sin
    <frac|x-a|2>|sin <frac|x+a|2>>|)><rsup|n-1>>>|<row|<cell|f<rprime|'><around*|(|x|)>>|<cell|=>|<cell|<around*|(|n-1|)>*<around*|(|<frac|sin
    <frac|x-a|2>|sin <frac|x+a|2>>|)><rsup|n-2>\<times\><frac|sin
    a|2*sin<rsup|2> <frac|x+a|2>>>>|<row|<cell|<frac|2*sin
    a|n-1>*f<rprime|'><around*|(|x|)>>|<cell|=>|<cell|<around*|(|<frac|sin
    <frac|x-a|2>|sin <frac|x+a|2>>|)><rsup|n-2>\<times\><frac|sin<rsup|2>
    a|sin<rsup|2> <frac|x+a|2>>>>|<row|<cell|>|<cell|>|<cell|<frac|sin
    <frac|x-a|2>|sin <frac|x+a|2>>\<times\>2*cos a-1+<frac|sin<rsup|2>
    a|sin<rsup|2> <frac|x+a|2>>>>|<row|<cell|>|<cell|=>|<cell|<frac|sin
    <frac|x-a|2>\<times\>sin <frac|x+a|2>\<times\>2*cos a-sin<rsup|2>
    <frac|x+a|2>+sin<rsup|2> a|sin<rsup|2>
    <frac|x+a|2>>>>|<row|<cell|t<around*|(|x|)>>|<cell|=>|<cell|sin
    <frac|x-a|2>\<times\>sin <frac|x+a|2>\<times\>2*cos a-sin<rsup|2>
    <frac|x+a|2>+sin<rsup|2> a>>|<row|<cell|>|<cell|=>|<cell|<around*|(|cos
    a-cos x|)>*cos a-sin<rsup|2> <frac|x+a|2>+sin<rsup|2>
    a>>|<row|<cell|>|<cell|=>|<cell|1-sin<rsup|2> <frac|x+a|2>-cos x*cos
    a>>|<row|<cell|<text|I. \ >sin \<alpha\>*sin
    ...
    >sin \<alpha\>*cos \<beta\>>|<cell|=>|<cell|<frac|1|2>*<around*|[|sin<around*|(|\<alpha\>-\<beta\>|)>+sin<around*|(|\<alpha\>+\<beta\>|)>|]>>>|<row|<cell|sin<rsup|2>
    \<theta\>>|<cell|=>|<cell|<frac|1-cos
  ...
  <\eqnarray*>
    ...
    v=a*e<rsup|a*x>*d x,v=e<rsup|a*x>>>|<row|<cell|F<around*|(|x|)>>|<cell|=>|<cell|<big|int>u*d
  ...
  <\eqnarray*>
    <tformat|<table|<row|<cell|F<around*|(|x|)>>|<cell|=>|<cell|<big|int>P<around*|(|x|)>*cos
    a*x*d x>>|<row|<cell|>|<cell|>|<cell|u=<frac|P<around*|(|x|)>|a>,d
    v=a*cos a*x*d x,v=sin a*x>>|<row|<cell|F<around*|(|x|)>>|<cell|=>|<cell|<big|int>u*d
    v=u*v-<big|int>v*d u>>|<row|<cell|>|<cell|=>|<cell|sin
    a*x*<frac|P<around*|(|x|)>|a>-<big|int>sin
    a*x*d<around*|(|<frac|P<around*|(|x|)>|a>|)>>>|<row|<cell|>|<cell|=>|<cell|<frac|sin
    a*x|a>*P<around*|(|x|)>-<frac|1|a>*<big|int>sin
    a*x*P<rprime|'><around*|(|x|)>*d x>>|<row|<cell|s<around*|(|x|)>>|<cell|=>|<cell|<big|int>sin
    a*x*Q<around*|(|x|)>*d x>>|<row|<cell|>|<cell|>|<cell|u=-<frac|Q<around*|(|x|)>|a>,d
    v=-a*sin a*x*d x,v=cos a*x>>|<row|<cell|s<around*|(|x|)>>|<cell|=>|<cell|<big|int>u*d
    v=u*v-<big|int>v*d u>>|<row|<cell|>|<cell|=>|<cell|-<frac|cos
    a*x|a>*Q<around*|(|x|)>-<big|int>cos a*x*d<around*|(|-<frac|Q<around*|(|x|)>|a>|)>>>|<row|<cell|>|<cell|=>|<cell|-<frac|cos
    a*x|a>*Q<around*|(|x|)>+<frac|1|a>*<big|int>Q<rprime|'><around*|(|x|)>*cos
    a*x*d x>>|<row|<cell|F<around*|(|x|)>>|<cell|=>|<cell|<frac|sin
    a*x|a>*P<around*|(|x|)>-<frac|1|a>*<around*|(|-<frac|cos
    a*x|a>*P<rprime|'><around*|(|x|)>+<frac|1|a>*<big|int>P<rprime|''><around*|(|x|)>*cos
    a*x*d x|)>>>|<row|<cell|>|<cell|=>|<cell|<frac|sin
    a*x|a>*P<around*|(|x|)>+<frac|cos a*x|a<rsup|2>>*P<rprime|'><around*|(|x|)>-<frac|1|a<rsup|2>>*<big|int>P<rprime|''><around*|(|x|)>*cos
    a*x*d x>>|<row|<cell|>|<cell|=>|<cell|<frac|sin
    a*x|a>*P<around*|(|x|)>+<frac|cos a*x|a<rsup|2>>*P<rprime|'><around*|(|x|)>-<frac|1|a<rsup|2>>*<around*|(|<frac|sin
    a*x|a>*P<rprime|''><around*|(|x|)>+<frac|cos
    a*x|a<rsup|2>>*P<rprime|'''><around*|(|x|)>-<frac|1|a<rsup|2>>*<big|int>P<rprime|''''><around*|(|x|)>*cos
    a*x*d x|)>>>|<row|<cell|>|<cell|=>|<cell|<frac|sin
    a*x|a>*<around*|(|P<around*|(|x|)>-<frac|P<rprime|''><around*|(|x|)>|a<rsup|3>>|)>+<frac|cos
    a*x|a<rsup|2>>*<around*|(|P<rprime|'><around*|(|x|)>-<frac|P<rprime|'''><around*|(|x|)>|a<rsup|4>>|)>+<frac|1|a<rsup|4>>*<big|int>P<rprime|''''><around*|(|x|)>*cos
    a*x*d x>>>>
  </eqnarray*>
  ...
  <\eqnarray*>
    <tformat|<table|<row|<cell|F<around*|(|x|)>>|<cell|=>|<cell|<big|int>P<around*|(|x|)>*sin
    a*x*d x>>|<row|<cell|s<around*|(|x|)>>|<cell|=>|<cell|<big|int>sin
    a*x*Q<around*|(|x|)>*d x=-<frac|cos a*x|a>*Q<around*|(|x|)>+<frac|1|a>*<big|int>Q<rprime|'><around*|(|x|)>*cos
    a*x*d x>>|<row|<cell|F<around*|(|x|)>>|<cell|=>|<cell|-<frac|cos
    a*x|a>*P<around*|(|x|)>+<frac|1|a>*<big|int>P<rprime|'><around*|(|x|)>*cos
    a*x*d x>>|<row|<cell|>|<cell|=>|<cell|-<frac|cos
    a*x|a>*P<around*|(|x|)>+<frac|1|a>*<around*|(|<frac|sin
    a*x|a>*P<rprime|'><around*|(|x|)>-<frac|1|a>*<big|int>sin
    a*x*P<rprime|''><around*|(|x|)>*d x|)>>>|<row|<cell|>|<cell|=>|<cell|-<frac|cos
    a*x|a>*P<around*|(|x|)>+<frac|sin a*x|a<rsup|2>>*P<rprime|'><around*|(|x|)>-<frac|1|a<rsup|2>>*<big|int>sin
    a*x*P<rprime|''><around*|(|x|)>*d x>>|<row|<cell|>|<cell|=>|<cell|-<frac|cos
    a*x|a>*P<around*|(|x|)>+<frac|sin a*x|a<rsup|2>>*P<rprime|'><around*|(|x|)>-<frac|1|a<rsup|2>>*<around*|(|-<frac|cos
    a*x|a>*P<rprime|''><around*|(|x|)>+<frac|1|a>*<big|int>P<rprime|'''><around*|(|x|)>*cos
    a*x*d x|)>>>|<row|<cell|>|<cell|=>|<cell|-<frac|cos
    a*x|a>*<around*|(|P<around*|(|x|)>-<frac|P<rprime|''><around*|(|x|)>|a<rsup|2>>|)>+<frac|sin
    a*x|a<rsup|2>>*P<rprime|'><around*|(|x|)>-<frac|1|a<rsup|3>>*<big|int>P<rprime|'''><around*|(|x|)>*cos
    a*x*d x>>|<row|<cell|>|<cell|=>|<cell|-<frac|cos
    a*x|a>*<around*|(|P<around*|(|x|)>-<frac|P<rprime|''><around*|(|x|)>|a<rsup|2>>|)>+<frac|sin
    a*x|a<rsup|2>>*P<rprime|'><around*|(|x|)>-<frac|1|a<rsup|3>>*<around*|(|<frac|sin
    a*x|a>*P<rprime|'''><around*|(|x|)>-<frac|1|a>*<big|int>sin
    a*x*P<rprime|''''><around*|(|x|)>*d x|)>>>|<row|<cell|>|<cell|=>|<cell|-<frac|cos
    a*x|a>*<around*|(|P<around*|(|x|)>-<frac|P<rprime|''><around*|(|x|)>|a<rsup|2>>|)>+<frac|sin
