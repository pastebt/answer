...
<\body>
  ...
  <\eqnarray*>
    ...
    t>>|<row|<cell|>|<cell|=>|<cell|<frac|1|<around*|(|<sqrt|2>*a|)><rsup|3>>*<big|int><around*|(|<frac|2*t+<sqrt|2>*a|t<rsup|2>+<sqrt|2>*a*t+a<rsup|2>>-<frac|2*t-<sqrt|2>*a|t<rsup|2>-<sqrt|2>*a*t+a<rsup|2>>+<frac|<sqrt|2>*a|t<rsup|2>+<sqrt|2>*a*t+a<rsup|2>>-<frac|-<sqrt|2>*a|t<rsup|2>-<sqrt|2>*a*t+a<rsup|2>>|)>*d
    t>>|<row|<cell|>|<cell|=>|<cell|<frac|1|<around*|(|<sqrt|2>*a|)><rsup|3>>*<around*|(|l
    n<around*|\||<frac|t<rsup|2>+<sqrt|2>*a*t+a<rsup|2>|t<rsup|2>-<sqrt|2>*a*t+a<rsup|2>>|\|>|)>+<frac|1|<around*|(|<sqrt|2>*a|)><rsup|2>>*<big|int><around*|(|<frac|1|t<rsup|2>+<sqrt|2>*a*t+a<rsup|2>>+<frac|1|t<rsup|2>-<sqrt|2>*a*t+a<rsup|2>>|)>*d
    t>>|<row|<cell|>|<cell|=>|<cell|<frac|1|<around*|(|<sqrt|2>*a|)><rsup|3>>*<around*|(|l
    n<around*|\||<frac|t<rsup|2>+<sqrt|2>*a*t+a<rsup|2>|t<rsup|2>-<sqrt|2>*a*t+a<rsup|2>>|\|>|)>+<frac|1|2*a<rsup|2>>*<big|int><frac|2*t<rsup|2>+2*a<rsup|2>|t<rsup|4>+2*a<rsup|2>*t<rsup|2>+a<rsup|4>-2*a<rsup|2>*t<rsup|2>>*d
    t>>|<row|<cell|>|<cell|=>|<cell|<frac|1|<around*|(|<sqrt|2>*a|)><rsup|3>>*<around*|(|l
    n<around*|\||<frac|t<rsup|2>+<sqrt|2>*a*t+a<rsup|2>|t<rsup|2>-<sqrt|2>*a*t+a<rsup|2>>|\|>|)>+<frac|1|a<rsup|2>>*<big|int><frac|t<rsup|2>+a<rsup|2>|t<rsup|4>+a<rsup|4>>*d
