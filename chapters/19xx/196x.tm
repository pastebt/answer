...
<\body>
  ...
  <\eqnarray*>
    ...
    z>>|<row|<cell|>|<cell|=>|<cell|<big|int><frac|-2*z*<around*|(|z+2|)>|<around*|(|z+1|)><rsup|3>*<around*|(|z-1|)>*<around*|(|z-2|)>>*d
    x>>|<row|<cell|>|<cell|=>|<cell|-2*<big|int><frac|z<rsup|2>+2*z+1-1|<around*|(|z+1|)><rsup|3>*<around*|(|z-1|)>*<around*|(|z-2|)>>*d
    z>>|<row|<cell|>|<cell|=>|<cell|-2*<big|int><around*|(|<frac|1|<around*|(|z+1|)>*<around*|(|z-1|)>*<around*|(|z-2|)>>-<frac|1|<around*|(|z+1|)><rsup|3>*<around*|(|z-1|)>*<around*|(|z-2|)>>|)>*d
    z>>|<row|<cell|>|<cell|=>|<cell|-2*<big|int><around*|(|1-<frac|1|<around*|(|z+1|)><rsup|2>>|)>\<times\><frac|1|<around*|(|z+1|)>*<around*|(|z-1|)>*<around*|(|z-2|)>>*d
    z>>|<row|<cell|f<rsub|1><around*|(|z|)>>|<cell|=>|<cell|<frac|1|<around*|(|z+1|)>*<around*|(|z-1|)>*<around*|(|z-2|)>>=<frac|1|z+1>\<times\><around*|(|<frac|1|z-2>-<frac|1|z-1>|)>>>|<row|<cell|>|<cell|=>|<cell|<frac|1|<around*|(|z+1|)>*<around*|(|z-2|)>>-<frac|1|<around*|(|z+1|)>*<around*|(|z-1|)>>=<frac|1|3>*<around*|(|<frac|1|z-2>-<frac|1|z+1>|)>-<frac|1|2><around*|(|<frac|1|z-1>-<frac|1|z+1>|)>>>|<row|<cell|>|<cell|=>|<cell|<frac|1|3*<around*|(|z-2|)>>-<frac|1|2*<around*|(|z-1|)>>+<frac|1|6*<around*|(|z+1|)>>>>|<row|<cell|f<rsub|2><around*|(|z|)>>|<cell|=>|<cell|<frac|1|<around*|(|z+1|)><rsup|2>>*f<rsub|1><around*|(|x|)>=<frac|1|z+1>*<around*|(|<frac|1|3*<around*|(|z-2|)>*<around*|(|z+1|)>>-<frac|1|2*<around*|(|z-1|)>*<around*|(|z+1|)>>|)>+<frac|1|6*<around*|(|x+1|)><rsup|3>>>>|<row|<cell|>|<cell|=>|<cell|<frac|1|z+1>*<around*|(|<frac|1|3>*<around*|(|<frac|1|3>*<around*|(|<frac|1|z-2>-<frac|1|z+1>|)>|)>-<frac|1|2>*<around*|(|<frac|1|2>*<around*|(|<frac|1|z-1>-<frac|1|z+1>|)>|)>|)>+<frac|1|6*<around*|(|x+1|)><rsup|3>>>>|<row|<cell|>|<cell|=>|<cell|<frac|1|z+1>*<around*|(|<frac|1|9>\<times\><frac|1|z-2>-<frac|1|4>\<times\><frac|1|z-1>+<frac|5|36>\<times\><frac|1|z+1>|)>+<frac|1|6*<around*|(|x+1|)><rsup|3>>>>|<row|<cell|>|<cell|=>|<cell|<frac|1|9>\<times\><frac|1|<around*|(|z+1|)>*<around*|(|z-2|)>>-<frac|1|4>\<times\><frac|1|<around*|(|z+1|)>*<around*|(|z-1|)>>+<frac|5|36>\<times\><frac|1|<around*|(|z+1|)><rsup|2>>+<frac|1|6*<around*|(|x+1|)><rsup|3>>>>|<row|<cell|>|<cell|=>|<cell|<frac|1|9><around*|(|<frac|1|3>*<around*|(|<frac|1|z-2>-<frac|1|z+1>|)>|)>-<frac|1|4>*<around*|(|<frac|1|2>*<around*|(|<frac|1|z-1>-<frac|1|z+1>|)>|)>+<frac|5|36>\<times\><frac|1|<around*|(|z+1|)><rsup|2>>+<frac|1|6*<around*|(|x+1|)><rsup|3>>>>|<row|<cell|>|<cell|=>|<cell|<frac|1|27*<around*|(|z-2|)>>-<frac|1|8*<around*|(|z-1|)>>+<frac|19|216<around*|(|z+1|)>>+<frac|5|36*<around*|(|z+1|)><rsup|2>>+<frac|1|6*<around*|(|x+1|)><rsup|3>>>>|<row|<cell|F<around*|(|z|)>>|<cell|=>|<cell|-2*<big|int><around*|(|f<rsub|1><around*|(|z|)>-f<rsub|2><around*|(|z|)>|)>*d
    z>>|<row|<cell|>|<cell|=>|<cell|-2*<big|int><around*|(|<frac|1|3*<around*|(|z-2|)>>-<frac|1|2*<around*|(|z-1|)>>+<frac|1|6*<around*|(|z+1|)>>-<around*|(|<frac|1|27*<around*|(|z-2|)>>-<frac|1|8*<around*|(|z-1|)>>+<frac|19|216<around*|(|z+1|)>>+<frac|5|36*<around*|(|z+1|)><rsup|2>>+<frac|1|6*<around*|(|x+1|)><rsup|3>>|)>|)>*d
    z>>|<row|<cell|>|<cell|=>|<cell|-2*<big|int><around*|(|<frac|8|27*<around*|(|z-2|)>>-<frac|3|8*<around*|(|z-1|)>>+<frac|17|216*<around*|(|z+1|)>>-<frac|5|36*<around*|(|z+1|)><rsup|2>>-<frac|1|6*<around*|(|z+1|)><rsup|3>>|)>*d<around*|(|z+1|)>>>|<row|<cell|>|<cell|=>|<cell|<big|int><around*|(|<frac|1|3*<around*|(|z+1|)><rsup|3>>+<frac|5|18*<around*|(|z+1|)><rsup|2>>-<frac|17|108*<around*|(|z+1|)>>+<frac|3|4*<around*|(|<around*|(|z+1|)>-2|)>>-<frac|16|27*<around*|(|<around*|(|z+1|)>-3|)>>|)>*d<around*|(|z+1|)>>>|<row|<cell|>|<cell|=>|<cell|-<frac|1|6*<around*|(|z+1|)><rsup|2>>-<frac|5|18*<around*|(|z+1|)>>-<frac|17|108>*l
    n<around*|\||z+1|\|>+<frac|3|4>*l n<around*|\||z-1|\|>-<frac|16|27>*l
    n<around*|\||z-2|\|>>>>>
  </eqnarray*>
</body>
