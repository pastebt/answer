...
<\body>
  ...
  <\eqnarray*>
    <tformat|<table|<row|<cell|F<around*|(|x|)>>|<cell|=>|<cell|<big|int><frac|1+sin
    x|1+cos x>*e<rsup|x>*d x>>|<row|<cell|>|<cell|=>|<cell|<big|int><around*|(|<frac|1|1+cos
    x>+<frac|sin x|1+cos x>|)>*e<rsup|x>*d x>>|<row|<cell|cos<rsup|2>
    \<theta\>>|<cell|=>|<cell|<frac|1+cos 2*\<theta\>|2>>>|<row|<cell|tan
    <frac|\<theta\>|2>>|<cell|=>|<cell|<frac|sin \<theta\>|1+cos
    \<theta\>>>>|<row|<cell|F<around*|(|x|)>>|<cell|=>|<cell|<big|int><frac|e<rsup|x>*d
    x|2*cos<rsup|2> <frac|x|2>>+<big|int>tan <frac|x|2>*e<rsup|x>*d
    x>>|<row|<cell|>|<cell|>|<cell|u=tan <frac|x|2>,d v=e<rsup|x>*d
    x,v=e<rsup|x>>>|<row|<cell|F<around*|(|x|)>>|<cell|=>|<cell|<big|int><frac|e<rsup|x>*d
    x|2*cos<rsup|2> <frac|x|2>>+<big|int>u*d v=<big|int><frac|e<rsup|x>*d
    x|2*cos<rsup|2> <frac|x|2>>+u*v-<big|int>v*d
    u>>|<row|<cell|>|<cell|=>|<cell|<big|int><frac|e<rsup|x>*d
    x|2*cos<rsup|2> <frac|x|2>>+e<rsup|x>*tan
    <frac|x|2>-<big|int>e<rsup|x>*d<around*|(|tan
    <frac|x|2>|)>>>|<row|<cell|>|<cell|=>|<cell|<big|int><frac|e<rsup|x>*d
    x|2*cos<rsup|2> <frac|x|2>>+e<rsup|x>*tan
  ...
  <\eqnarray*>
    <tformat|<table|<row|<cell|F<around*|(|x|)>>|<cell|=>|<cell|<big|int><around*|(|<around*|\||1+x|\|>-<around*|\||1-x|\|>|)>*d
    x>>|<row|<cell|>|<cell|=>|<cell|<big|int><around*|\||1+x|\|>*d
    x-<big|int><around*|\||1-x|\|>*d x>>|<row|<cell|>|<cell|=>|<cell|<big|int><around*|\||1+x|\|>*d<around*|(|1+x|)>+<big|int><around*|\||1-x|\|>*d<around*|(|1-x|)>>>|<row|<cell|>|<cell|>|<cell|<big|int><around*|\||x|\|>*d
    x=<frac|x|2>*<around*|\||x|\|>>>|<row|<cell|F<around*|(|x|)>>|<cell|=>|<cell|<frac|<around*|(|1+x|)>*<around*|\||1+x|\|>|2>+<frac|<around*|(|1-x|)>*<around*|\||1-x|\|>|2>>>>>
  </eqnarray*>
</body>
