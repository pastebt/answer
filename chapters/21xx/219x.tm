...
<\body>
  ...
  <\eqnarray*>
    ...
    n<around*|(|1-2*\<alpha\>*cos<around*|(|<frac|i*\<pi\>|n>|)>+\<alpha\><rsup|2>|)>*<frac|\<pi\>|n>|)>>>|<row|<cell|>|<cell|=>|<cell|lim<rsub|n\<rightarrow\>\<infty\>>
    F<rsub|1><around*|(|n|)>>>|<row|<cell|F<rsub|1><around*|(|n|)>>|<cell|=>|<cell|<big|sum><rsub|i=0><rsup|n-1>l
