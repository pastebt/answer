...
<\body>
  ...
  <\eqnarray*>
    ...
    x>>|<row|<cell|>|<cell|=>|<cell|<big|int><around*|(|<frac|1|x<rsup|4>*<around*|(|x<rsup|4>-1|)>>-<frac|1|x<rsup|8>>|)>*d
    x=<big|int><around*|(|<frac|1|x<rsup|4>-1>-<frac|1|x<rsup|4>>-<frac|1|x<rsup|8>>|)>*d
