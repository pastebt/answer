...
<\body>
  ...
  <\eqnarray*>
    <tformat|<table|<row|<cell|F<around*|(|n|)>>|<cell|=>|<cell|2!*4!*\<cdots\>*<around*|(|2*n|)>!>>|<row|<cell|G<around*|(|n|)>>|<cell|=>|<cell|<around*|(|<around*|(|n+1|)>!|)><rsup|n>>>|<row|<cell|F<around*|(|2|)>>|<cell|=>|<cell|2!*4!=2\<times\>24=48>>|<row|<cell|G<around*|(|2|)>>|<cell|=>|<cell|<around*|(|<around*|(|2+1|)>!|)><rsup|2>=<around*|(|1\<times\>2\<times\>3|)><rsup|2>=36>>|<row|<cell|F*<around*|(|2|)>>|<cell|\<gtr\>>|<cell|G<around*|(|2|)>>>|<row|<cell|F<around*|(|n|)>>|<cell|\<gtr\>>|<cell|G<around*|(|n|)>>>|<row|<cell|F<around*|(|n+1|)>>|<cell|=>|<cell|2!*4!*\<cdots\>*<around*|(|2*n|)>!\<times\><around*|(|2<around*|(|n+1|)>|)>!>>|<row|<cell|>|<cell|\<gtr\>>|<cell|G<around*|(|n|)>\<times\><around*|(|2<around*|(|n+1|)>|)>!>>|<row|<cell|>|<cell|=>|<cell|<around*|(|<around*|(|n+1|)>!|)><rsup|n>\<times\><around*|(|n+1|)>!\<times\><around*|(|<around*|(|n+2|)>\<times\><around*|(|n+3|)>\<times\>\<cdots\>\<times\><around*|(|2*n+2|)>|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|<around*|(|n+1|)>!|)><rsup|n+1>\<times\><around*|(|<around*|(|n+2|)>\<times\><around*|(|n+3|)>\<times\>\<cdots\>\<times\><around*|(|2*n+2|)>|)>>>|<row|<cell|G<around*|(|n+1|)>>|<cell|=>|<cell|<around*|(|<around*|(|<around*|(|n+1|)>+1|)>!|)><rsup|n+1>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|<around*|(|n+1|)>!\<times\><around*|(|n+1+1|)>|)><rsup|n+1>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|<around*|(|n+1|)>!|)><rsup|n+1>\<times\><around*|(|n+2|)><rsup|n+1>>>|<row|<cell|>|<cell|>|<cell|n\<gtr\>1>>|<row|<cell|<around*|(|n+2|)><rsup|n+1>>|<cell|\<less\>>|<cell|<around*|(|<around*|(|n+2|)>\<times\><around*|(|n+3|)>\<times\>\<cdots\>\<times\><around*|(|2*n+2|)>|)>>>|<row|<cell|F<around*|(|n+1|)>>|<cell|\<gtr\>>|<cell|G<around*|(|n+1|)>>>>>
  </eqnarray*>
  ...
  <\eqnarray*>
    <tformat|<table|<row|<cell|F<around*|(|n|)>>|<cell|=>|<cell|<frac|1|2>\<times\><frac|3|4>\<times\>\<cdots\>\<times\><frac|2*n-1|2*n>>>|<row|<cell|G<around*|(|n|)>>|<cell|=>|<cell|<frac|1|<sqrt|2*n+1>>>>|<row|<cell|F<around*|(|2|)>>|<cell|=>|<cell|<frac|1|2>\<times\><frac|3|4>=<frac|3|8>=<sqrt|0.14625>>>|<row|<cell|G<around*|(|2|)>>|<cell|=>|<cell|<frac|1|<sqrt|5>>=<sqrt|0.2>>>|<row|<cell|F<around*|(|2|)>>|<cell|\<less\>>|<cell|G<around*|(|2|)>>>|<row|<cell|F<around*|(|n|)>>|<cell|\<less\>>|<cell|G<around*|(|n|)>>>|<row|<cell|F<around*|(|n+1|)>>|<cell|=>|<cell|F<around*|(|n|)>\<times\><frac|2*<around*|(|n+1|)>-1|2<around*|(|n+1|)>>>>|<row|<cell|>|<cell|\<less\>>|<cell|G<around*|(|n|)>\<times\><frac|2*<around*|(|n+1|)>-1|2<around*|(|n+1|)>>>>|<row|<cell|>|<cell|=>|<cell|<frac|1|<sqrt|2*n+1>>\<times\><frac|2*n+1|2*<around*|(|n+1|)>>>>|<row|<cell|G<around*|(|n+1|)>>|<cell|=>|<cell|<frac|1|<sqrt|2<around*|(|n+1|)>+1>>=<frac|1|<sqrt|2*n+3>>>>|<row|<cell|n>|<cell|\<gtr\>>|<cell|1>>|<row|<cell|4*n<rsup|2>+8*n+4>|<cell|\<gtr\>>|<cell|4*n<rsup|2>+8*n+3>>|<row|<cell|<around*|(|2*<around*|(|n+1|)>|)><rsup|2>>|<cell|\<gtr\>>|<cell|<around*|(|2*n+1|)>*<around*|(|2*n+3|)>>>|<row|<cell|<frac|1|<around*|(|2*<around*|(|n+1|)>|)><rsup|2>>>|<cell|\<less\>>|<cell|<frac|1|<around*|(|2*n+1|)>*<around*|(|2*n+3|)>>>>|<row|<cell|<frac|<around*|(|2*n+1|)><rsup|2>|<around*|(|2*<around*|(|n+1|)>|)><rsup|2>>>|<cell|\<less\>>|<cell|<frac|2*n+1|2*n+3>>>|<row|<cell|<around*|(|<frac|2<around*|(|n+1|)>-1|2*<around*|(|n+1|)>>|)><rsup|2>>|<cell|\<less\>>|<cell|<frac|2*n+1|2*n+3>>>|<row|<cell|<frac|2<around*|(|n+1|)>-1|2*<around*|(|n+1|)>>>|<cell|\<less\>>|<cell|<sqrt|<frac|2*n+1|2*n+3>>>>|<row|<cell|<frac|1|<sqrt|2*n+1>>\<times\><frac|2<around*|(|n+1|)>-1|2*<around*|(|n+1|)>>>|<cell|\<less\>>|<cell|<frac|1|<sqrt|2*<around*|(|n+1|)>+1>>>>|<row|<cell|G<around*|(|n|)>\<times\><frac|2<around*|(|n+1|)>-1|2*<around*|(|n+1|)>>>|<cell|\<less\>>|<cell|G<around*|(|n+1|)>>>|<row|<cell|F<around*|(|n+1|)>>|<cell|\<less\>>|<cell|G<around*|(|n|)>\<times\><frac|2<around*|(|n+1|)>-1|2*<around*|(|n+1|)>>>>|<row|<cell|>|<cell|\<less\>>|<cell|G<around*|(|n+1|)>>>>>
  </eqnarray*>
</body>
